...
func (ServerStatus_StatusCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_728c96f0a6320abd, []int{0, 0}
}
...
func (*ServerStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_728c96f0a6320abd, []int{0}
}
...
func init() { proto.RegisterFile("server_admin.proto", fileDescriptor_728c96f0a6320abd) }

var fileDescriptor_728c96f0a6320abd = []byte{
	...
	0x30, 0xc9, 0xda, 0x6d, 0x40, 0x1e, 0xcc, 0x2f, 0x20, 0x4f, 0xb7, 0x93, 0x52, 0x94, 0x42, 0x7a,
	0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x7e, 0x62, 0x52, 0x72, 0x46, 0x62, 0x66,
	0x9e, 0x7e, 0x5a, 0x62, 0x52, 0x51, 0x66, 0x32, 0x24, 0x6a, 0x8a, 0x93, 0x20, 0x31, 0x66, 0x0c,
	0x08, 0x00, 0x00, 0xff, 0xff, 0x42, 0x4a, 0xa1, 0x77, 0xce, 0x01, 0x00, 0x00,
}
...
func (c *adminClient) StopServer(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ServerStatus, error) {
	out := new(ServerStatus)
	err := c.cc.Invoke(ctx, "/protos.Admin/StopServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Admin_StopServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).StopServer(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
